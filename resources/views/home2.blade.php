                ...
                html5QrCode.start(
                    ...
                    (decodedText, decodedResult) => {
                        ...
                        if (matchedRow) {
                            ...
                            let productPrice = parseFloat(matchedRow.getAttribute('data-price'));
                            let offPrice = parseFloat(matchedRow.getAttribute('data-off-price')) || 0;
                            let productSize = matchedRow.getAttribute('data-size') || '';
                            let quantityElement = matchedRow.querySelector('.quantity');
                            let quantity = parseInt(quantityElement.innerText);
                            ...
                            Swal.fire({
                                icon: 'warning',
                                title: 'Not Found',
                                text: 'Scanned product not found in list.',
                                confirmButtonText: 'OK'
                            });
                        }

                        // ⏱ Delay 1 second before next scan allowed
                        setTimeout(() => {
                            scanCooldown = false;
                        }, 1000);
                    },
